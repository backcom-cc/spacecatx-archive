...
| **제품명** | **깨우기 방식** | **가격대 (쿠팡 기준)** |
| --- | --- | --- |
| **[닌텐도 공식 프로콘](#procon)** | 홈 버튼 | 10~13만 원대 |
| **[8BitDo Ultimate BT 2](#8bitdo)** | 흔들기(Shake) | 4~5만 원대 |
| **[GameSir Super Nova T4N](#supernova)** | 홈 버튼 / 움직임 | 3만 원대 |
| **[Mobapad 치투 2](#chitu)** | 홈 버튼 | 4만 원대 |
| **[Mobapad 휴벤 2](#huben)** | 홈 버튼 | 6~7만 원대 |
| **[제닉스 TITAN GP7](#gp7)** | 홈 버튼 | 7만 원대 |
| **[GuliKit TT Max](#ttmax)** | 홈 버튼 | 9만 원대 |
...
저는 현재 **프로콘2와 8BitDo Ultimate2, 치투2를 사용 중**이에요.  
